...
def head(title, desc, page):
    ...
    share = SITE_IMG.get("heroImage") or (SITE_URL + "/images/hero-desk.webp")
...
def ed_img(slot, default_local):
    ...
    u = SITE_IMG.get(slot)
    return u if u else f"images/{default_local}.webp"
...
<main>
  <section class="hero">
    <div class="hero-media" data-parallax="0.12">
      <img src="{ed_img('heroImage','hero-desk')}" alt="Maison Valér cognac leather desk essentials" width="1900" height="1900" fetchpriority="high">
    </div>
  ...
  <section class="section ethos">
    <div class="wrap grid two">
      ...
      <div class="reveal d1">
        <div class="figure tall"><img src="{ed_img('homeImage1','organizer-fan')}" alt="Organizer in brown, gray and black leather" loading="lazy" width="1100" height="880"></div>
      </div>
    </div>
  </section>
  ...
  <section class="section band">
    <div class="wrap grid two">
      <div class="reveal">
        <div class="figure" style="aspect-ratio:1/1"><img src="{ed_img('homeFeature','mascots')}" alt="The Desk to Destinations leather characters" loading="lazy" width="1195" height="1195"></div>
      </div>
      <div class="reveal d1">
  ...
  <section class="section">
    <div class="wrap grid two">
      <div class="reveal">
        <div class="figure tall"><img src="{ed_img('homeImage2','briefcase')}" alt="Executive with leather essentials and briefcase" loading="lazy" width="1100" height="1473"></div>
      </div>
      <div class="reveal d1">
...
<main>
  <section class="d2d-hero">
    <div class="hero-media" data-parallax="0.1"><img src="{ed_img('homeFeature','mascots')}" alt="The Desk to Destinations leather characters at the airport" width="1195" height="1688" fetchpriority="high"></div>
    <div class="hero-inner wrap">
...
<main>
  <section class="section section--tight" style="padding-top:clamp(120px,16vh,190px)">
    <div class="wrap">
      ...
      <div class="grid two">
        <div class="reveal"><div class="figure tall"><img src="{ed_img('aboutImage2','life-organizer')}" alt="Executive using a Maison Valér organizer" loading="lazy" width="950" height="1187"></div></div>
        <div class="reveal d1">
  ...
  <section class="section">
    <div class="wrap grid two">
      ...
      <div class="reveal"><div class="figure tall"><img src="{ed_img('aboutImage1','airport-man')}" alt="Traveller with Maison Valér essentials at the airport" loading="lazy" width="1500" height="1094"></div></div>
    </div>
  </section>
</main>
''' + footer()
